...
void getToken()
{
    ...
    if (token == "")
    {
        ...
        Serial.println("http://" + String(server) + ":" + String(port) + "/api/getToken");
...
void sendData()
{
    ...
    Serial.println("http://" + String(server) + ":" + String(port) + "/api/save-data");
    HTTPClient http;
...
void setupWifiManager()
{
    ...
    wifiManager.autoConnect("TempSensor", "12345678");
